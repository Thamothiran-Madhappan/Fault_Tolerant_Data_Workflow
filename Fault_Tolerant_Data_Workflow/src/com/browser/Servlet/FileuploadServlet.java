...
public class FileuploadServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String fullpath=editpath+"Fault_Tolerant_Data_Workflow\\WebContent\\LOCAL\\";
		...
		while((part=mp.readNextPart())!=null)
			{
				...
				String encrpt = null;
				  ...
				  if (filename.endsWith(".txt")) {
		            ...
		            filepath1 = editpath + "Fault_Tolerant_Data_Workflow/WebContent/Decrypt/"+filename;
		            ...
		            file1.createNewFile();
		              ...
		              //file decrypted and store into filepath2
		        		    ...
		        		    filepath2 = editpath + "Fault_Tolerant_Data_Workflow/WebContent/Decrypt/"+filename;
